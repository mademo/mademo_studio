...
<main id="mademo-react-page" class="mademo-react-page" data-react-route="constellation" aria-label="<?php
if (function_exists('esc_attr_e')) {
    esc_attr_e('Constellation', 'mademo');
} else {
    echo 'Constellation';
}
?>">
